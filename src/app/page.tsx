      ...
      <main className="flex flex-col flex-1 items-center justify-center p-8 sm:p-24 bg-white dark:bg-black">
        <div className="max-w-3xl w-full text-center sm:text-left space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            ...
            <button className="px-8 py-4 border border-zinc-200 dark:border-zinc-800 text-black dark:text-white font-semibold rounded-lg hover:bg-zinc-50 dark:hover:bg-zinc-900 transition-colors">
              Admin Login
            </button>
          </div>
